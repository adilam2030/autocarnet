...
const buildSalesReportHtml=(car,ops=[])=>{
  ...
  const opsHtml=recentOps(ops,7).length
    ? recentOps(ops,7).map(o=>`
      <tr>
    ...
    `).join('')
    : `<tr><td colspan="4">Aucun entretien détaillé saisi</td></tr>`;
  ...
  <head>
    ...
    <style>
      ...
      .section { margin-top:24px; border:1px solid #e5e7eb; border-radius:16px; padding:18px; }
      .section h2 { font-size:17px; margin:0 0 12px 0; }
      table { width:100%; border-collapse:collapse; }
      td, th { padding:10px; border-bottom:1px solid #e5e7eb; font-size:13px; text-align:left; vertical-align:top; }
  ...
  <body>
    <div class="header">
      <p class="title">Rapport de suivi véhicule</p>
      <div class="subtitle">Fiche commerciale factuelle destinée à rassurer un acheteur</div>
    </div>
    ...
    <div class="section">
      <h2>🧾 Derniers entretiens enregistrés</h2>
      <table>
        <tr><th>Date</th><th>Opération</th><th>Kilométrage</th><th>Garage</th></tr>
        ${opsHtml}
      </table>
    </div>
    ...
    <div class="section">
      ...
      <div class="summary">
        ...
        Ce rapport met en avant des éléments vérifiables plutôt qu’un simple discours commercial.
      </div>
    </div>
