...
const SalesHealthReport=({car,ops})=>{
  ...
  return(
    <>
      ...
      <TouchableOpacity onPress={()=>Share.share({message:buildSalesReportText(car,ops)})} style={{backgroundColor:C.primary,borderRadius:14,paddingVertical:15,alignItems:'center',marginBottom:12}}>
        <Text style={{color:'#fff',fontSize:15,fontWeight:'800'}}>📤 Partager le rapport de vente</Text>
      </TouchableOpacity>
