...
const buildSalesReportHtml=(car,ops=[],photoDataUri='')=>{
  ...
  const model=(car.modele||'').toUpperCase();
  ...
  if(revStatus(car)==='ok')
    positives.push('Entretien régulier et prochaine révision maîtrisée');

  if(assStatus(car)==='ok')
    positives.push('Assurance à jour');

  if(vtStatus(car)==='ok'||carAge(car.dateMEC)<5)
    positives.push('Contrôle technique conforme selon les informations saisies');

  if(car.vignette?.payee)
    positives.push('Vignette renseignée comme payée');

  if(allOps.length>=3)
    positives.push('Historique d’entretien documenté');
  ...
  const photoBlock=photoDataUri
    ...
    : `
      <div class="vehicle-placeholder">
        <div class="placeholder-brand">${brand}</div>
        <div class="placeholder-model">${model}</div>
      </div>
    `;
  ...
  <body>
    ...
    <div class="page">
      ...
      <div class="header">
        ...
        <div class="header-right">
          ...
          <div class="header-sub">
            Rapport professionnel de suivi et d’entretien<br/>
            destiné à valoriser le véhicule lors de la vente
          </div>
        </div>
      </div>
      ...
      <div class="hero">
        ...
        <div class="vehicle-main">
          ...
          <div class="vehicle-meta">
            ...
            <div class="meta">
              <div class="meta-label">Prochaine révision</div>
              <div class="meta-value">${nextRevision}</div>
            </div>
          ...
          <div class="health">
            ...
            <div class="health-left">
              ...
              <div class="health-note">
                Basé sur l’historique d’entretien et les échéances renseignées
              </div>
            </div>
      ...
      <div class="section">
        ...
        <div class="points">
          ${positives.map(x=>`<div class="point">${x}</div>`).join('')}
        </div>
      ...
      <div class="section">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>Assurance</td>
              <td>${fmtDate(car.assurance?.echeance)}</td>
            </tr>

            <tr>
              <td>Contrôle technique</td>
              <td>${carAge(car.dateMEC)<5?'Non applicable':fmtDate(car.vt?.echeance)}</td>
            </tr>

            <tr>
              <td>Vignette</td>
              <td>${car.vignette?.payee?'Payée':'À vérifier'}</td>
            </tr>
          </tbody>
        </table>
      ...
      <div class="footer">
        ...
        <span>Document informatif basé sur les données saisies</span>
      </div>
    ...
    <div class="page">
      ...
      ${
        !historyHtml
        ? `<div style="margin-top:22px;color:#64748b">Aucun historique détaillé renseigné.</div>`
        : ''
      }
