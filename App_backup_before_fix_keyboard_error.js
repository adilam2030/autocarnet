...
import {
  View, Text, ScrollView, TouchableOpacity, StyleSheet, Image, KeyboardAvoidingView,
  StatusBar, Alert, TextInput, Switch,
  FlatList, Modal, ActivityIndicator, Share, Platform, BackHandler,
} from 'react-native';
...
const handleSave=async()=>{
  ...
  return(
    <SafeAreaView style={{flex:1,backgroundColor:'#fff',paddingTop:SAFE_TOP,paddingBottom:SAFE_BOTTOM,paddingTop:SAFE_TOP,paddingBottom:SAFE_BOTTOM}}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS==='ios'?'padding':'height'} style={{flex:1}} keyboardVerticalOffset={Platform.OS==='android'?20:0}>
      <ScrollView contentContainerStyle={{padding:20,paddingBottom:260}} keyboardShouldPersistTaps="handled">
