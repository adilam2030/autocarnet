...
const CarDetailScreen=({route,navigation})=>{
  ...
  const revisionInitiale=car.revision?.dernierKm&&car.revision?.derniereDate?[{id:"rev_init",type:"Vidange complète (huile + filtres)",date:car.revision.derniereDate,km:car.revision.dernierKm,garage:car.revision.garage||"",montant:0,note:"Révision initiale"}]:[];
