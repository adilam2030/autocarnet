...
{argus.marketLabel}
              ...
              <TouchableOpacity onPress={()=>setShowFine(v=>!v)} style={{marginTop:14,backgroundColor:showFine?C.dangerLight:C.primary,borderRadius:14,padding:14,alignItems:'center'}}>
