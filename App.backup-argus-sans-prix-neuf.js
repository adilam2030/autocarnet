...
const SettingsScreen=({navigation})=>{
  ...
  if(section==='expert'){
    return <ExpertSettingsScreen onBack={()=>setSection('menu')}/>;
  }
  ...
  return(
    <SafeAreaView style={{flex:1,backgroundColor:C.bg,paddingTop:SAFE_TOP,paddingBottom:SAFE_BOTTOM}}>
      ...
      <ScrollView contentContainerStyle={{padding:16,paddingBottom:260}}>
        ...
        <TouchableOpacity onPress={()=>setSection('expert')}>
          <Card style={{flexDirection:'row',alignItems:'center',gap:14}}>
            <Text style={{fontSize:34}}>🧠</Text>
            <View style={{flex:1}}>
              <Text style={{fontSize:18,fontWeight:'900',color:C.text}}>Paramètres expert</Text>
              <Text style={{fontSize:13,color:C.textLight,marginTop:3}}>
                Rafraîchir les prix du neuf utilisés par l’Argus.
              </Text>
            </View>
            <Text style={{fontSize:26,color:C.primary}}>›</Text>
          </Card>
...
{argus.marketLabel}
                ...
                <View style={{marginTop:12,backgroundColor:'#fff',borderRadius:12,padding:10}}>
                  <Text style={{fontSize:12,color:C.textLight}}>Prix neuf / WW estimé</Text>
                  <Text style={{fontSize:18,fontWeight:'900',color:C.text}}>{fmtMoney(argus.prixNeufEstime)}</Text>
                  <Text style={{fontSize:11,color:C.textLight,marginTop:4}}>Plafond occasion appliqué : {fmtMoney(argus.plafondOccasion)}</Text>
                </View>
