  ...
  return(
    <SafeAreaView style={{flex:1,backgroundColor:C.bg,paddingTop:SAFE_TOP,paddingBottom:SAFE_BOTTOM}}>
      ...
      <ScrollView contentContainerStyle={{padding:16,paddingBottom:260}}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('Argus')}>
          <Card style={{flexDirection:'row',alignItems:'center',gap:14}}>
            <Text style={{fontSize:34}}>🏭</Text>
            <View style={{flex:1}}>
              <Text style={{fontSize:18,fontWeight:'900',color:C.text}}>Santé constructeur</Text>
              <Text style={{fontSize:13,color:C.textLight,marginTop:3}}>
                Entretien recommandé, boîte, courroie, batterie.
              </Text>
            </View>
            <Text style={{fontSize:26,color:C.primary}}>›</Text>
          </Card>
...
const SalesHealthReport=({car,ops=[]})=>(
  <>
    ...
    <Btn label="📄 Générer et partager le PDF" onPress={()=>shareSalesReportPdf(car,ops)} style={{marginBottom:12}}/>
  </>
);
